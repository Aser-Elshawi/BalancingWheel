...
{.uartNumber = UART0_num,.baudRate = BAUD_RATE_115200,.parity = UART_PARITY_NONE,.dataSize = UART_WORD_LENGTH_8,.stopBits = UART_STOP_BIT_1,NULL,NULL,UARTERROR_uninitialized},
